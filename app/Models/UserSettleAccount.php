 ...
 */
class UserSettleAccount extends Model
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'user_settle_accounts';
    ...
    public function setRecipient($recipient)
    {
        ...
        } else if ($this->channel == UserSettleAccount::CHANNEL_WECHAT || $this->channel == UserSettleAccount::CHANNEL_WECHAT_WEB|| $this->channel == UserSettleAccount::CHANNEL_WECHAT_MOBILE || $this->channel == UserSettleAccount::CHANNEL_WECHAT_MINI_PROGRAM) {
            $recipient['force_check'] = $recipient['forceCheck'] ?? true;
        } else if ($this->channel == UserSettleAccount::CHANNEL_BANK_ACCOUNT) {
